...
enctype="multipart/form-data">
 ...
 <flux:input label="Name" name="name" value="{{ $category->name }}"
class="mb-3" />
 <flux:input label="Slug" name="slug" value="{{ $category->slug }}"
class="mb-3" />
...
$category->name }}" class="w-32 h-32 object-cover rounded">
 </div>
 @endif
